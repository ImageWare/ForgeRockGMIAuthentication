...
package com.iws.forgerock.GMITestNode;
...
@Node.Metadata(outcomeProvider  = AbstractDecisionNode.OutcomeProvider.class,
               configClass      = GMITestNode.Config.class)
public class GMITestNode extends AbstractDecisionNode {

    private final Config config;
    private final CoreWrapper coreWrapper;
    private final static String DEBUG_FILE = "GMITestNode";
     ...
     */
    @Inject
    public GMITestNode(@Assisted Config config, CoreWrapper coreWrapper) throws NodeProcessException {
        this.config = config;
