 ...
 * @since AM 5.5.0
 */
public class GMITestNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(GMITestNodePlugin.currentVersion, 
				Collections.singletonList(GMITestNode.class));
	}
	...
	public String getPluginVersion() {
		return GMITestNodePlugin.currentVersion;
	}
}
