...
@Node.Metadata(outcomeProvider  = AbstractDecisionNode.OutcomeProvider.class,
               configClass      = GMIValidateUser.Config.class)
public class GMIValidateUser extends AbstractDecisionNode {

    private final Config config;
    private final CoreWrapper coreWrapper;
    private final static String DEBUG_FILE = "GMIValidateUser";
...
*/
     ...
     */
    @Inject
    public GMIValidateUser(@Assisted Config config, CoreWrapper coreWrapper) throws NodeProcessException {
        this.config = config;
    ...
    public Action process(TreeContext context) throws NodeProcessException {
        ...
        String imageWareUsername = context.sharedState.get("USERNAME").asString();
        debug.message("[" + DEBUG_FILE + "]: " + "Username: '{}' ", imageWareUsername);
        
        if (imageWareUsername == null || imageWareUsername.isEmpty())
        {
