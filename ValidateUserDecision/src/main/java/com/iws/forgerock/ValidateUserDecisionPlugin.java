 ...
 * @since AM 5.5.0
 */
public class ValidateUserDecisionPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ValidateUserDecisionPlugin.currentVersion, 
				Collections.singletonList(ValidateUserDecision.class));
	}
	...
	public String getPluginVersion() {
		return ValidateUserDecisionPlugin.currentVersion;
	}
}
