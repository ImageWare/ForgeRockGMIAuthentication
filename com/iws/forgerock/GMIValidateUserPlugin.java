 ...
 * @since AM 5.5.0
 */
public class GMIValidateUserPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(GMIValidateUserPlugin.currentVersion, 
				Collections.singletonList(GMIValidateUser.class));
	}
	...
	public String getPluginVersion() {
		return GMIValidateUserPlugin.currentVersion;
	}
}
